# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 10:30:45 2020
...
# 0.020928; 0.9927999973297; 395.823; 32,bn,32,a,mp,bn,64,a,bn,64,mp,f,d256,dr(0.2),d10*
# 0.057546; 0.9864000082; 2074.42; 32,bn,32,bn,32,bn,dr0.4,64,bn,64,bn,64,bn,mp,dr0.4,d128,bn,f,dr(0.4),d10,nadam
# 32,bn,32,bn,32/3,bn,dr0.4, 64,bn,64,bn,64/5,bn,dr0.4,c128/4,bn,f,dr(0.4),d10,nadam
# 0.022506; 0.9933999776840; 2109.057; 32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c128/5,bn,f,dr(0.4),d10,nadam **
# 64,64,mp,bn,128,128,mp,bn,c256,mp,f,bn,d512,d10
# orig,c128,e=3
# 0.072331; 0.9868999719619; 3246.49; 32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c256/5,bn,f,dr(0.4),d10,nadam
# 0.024031; 0.9919000102043; 403.799; 32,32,mp,dr(0.25),64,64,mp,dr(0.25),f,d256,dr(0.5),d10
# 0.025638; 0.9909999966621; 562.313; 32,32,mp,dr0.2,64,64,mp,dr0.25,c128,dr0.25,f,d128,bn,dr0.25,d10

# 0.068950; 0.9879999756813; 2904.698; 32,bn,32,bn,32/5,bn,mp,dr0.25,64,bn,64,bn,64/5,bn,mp,dr,c128/5,bn,f,dr,d10,nadam
#  36,36,mp,36,36,mp,dr0.25,f,d512,bn,a,dr0.25,d10 ac.996
# 0.065944; 0.9865000247955; 2841.655; 32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c128/4,bn,f,dr0.4,d10 ac99.728
# 32,bn,32,bn,mp,dr0.25,64,bn,64,bn,mp,dr0.25,f,d512,bn,d0.25,d1024,bn,dr0.5,d10 acc99.66
#  32,32,bn,mp,dr0.2,64,64,bn,mp,dr0.2,f,d256,dr0.5,d10 acc99.4
# 32,LeakyReLU,32,LRelu,mp,dr0.25,64,lr,64,lr,mp,dr0.25,f,d256,d32,d10 acc99.67
# 32,32,mp,dr0.25,64,64,mp,dr0.25,f,d256,dr0.5,d10 acc99.7 RMSprop
# 0.024744; 0.9923999905586; 420.0611;  32,32,mp,dr0.25,64,64,mp,dr0.25,f,d256,dr0.5,d10 acc99.7 nadam
# 0.027314; 0.9907000064849; 638.6371; 32,bn,32,mp,dr0.25,64,bn,64,mp,dr0.25,f,d256,dr0.5,d10 nadam
# 0.026288; 0.990800023; 726.897; 32,bn,32,bn,mp,dr0.25,64,bn,64,bn,mp,dr0.25,f,d256,dr0.5,d10 nadam
# 32,mp,dr0.5,64,mp,dr0.5,64,f,d128,dr0.5,d10 acc99.21

# 0.022506; 0.9933999776840; 2109.057; 32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c128/5,bn,f,dr(0.4),d10,Adadelta e=3
# ; 32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c128/5,bn,f,dr(0.4),d10,Nadam e=3
# 0.025877; 0.9919000267982; 2304.523; 32,bn,32,bn,32/5,bn,mp,dr0.4,64,bn,64,bn,64/5,bn,mp,dr0.4,c128/5,bn,f,dr(0.4),d10,nadam, padding='same'
# 0.063917; 0.9847000241279; 4355.533; 32,bn,32,bn,32/5,bn,dr0.5,64,bn,64,bn,64/5,bn,dr0.5,c128/5,bn,f,dr(0.5),d10,nadam
#  32,bn,32,bn,32/5,bn,dr0.4,64,bn,64,bn,64/5,bn,dr0.4,c128/5,bn,f,dr(0.4),d10,nadam k=5all
model = Sequential()
...
model.add(Conv2D(32, (3, 3), activation='relu',padding='same')) # 64 filters in this layer
model.add(BatchNormalization())
model.add(Conv2D(32, (5, 5), activation='relu',padding='same')) # 64 filters in this layer
model.add(BatchNormalization())
#model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Dropout(0.4)) # randomly disables 25% of neurons (reduces overfitting)
model.add(Conv2D(64, (3, 3), activation='relu',padding='same')) # 64 filters in this layer
model.add(BatchNormalization())
model.add(Conv2D(64, (3, 3), activation='relu',padding='same')) # 64 filters in this layer
model.add(BatchNormalization())
model.add(Conv2D(64, (5, 5), activation='relu',padding='same')) # 64 filters in this layer
model.add(BatchNormalization())
...
#model.add(Flatten())
#model.add(Dense(256, activation='relu')) # batch size = 128 = hidden neuron units
model.add(Conv2D(128, (5, 5), activation='relu')) # 64 filters in this layer
model.add(BatchNormalization())
